...
{
    UIButton *plusBtn          = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.width, self.height)];

    self.plusBtn               = plusBtn;

    [plusBtn setImage:[UIImage imageNamed:self.iconName] forState:UIControlStateNormal];
    ...
    plusBtn.layer.cornerRadius = self.width/2.0f;
    //设置边缘的阴影效果
    plusBtn.layer.shadowColor = [UIColor darkGrayColor].CGColor;
    plusBtn.layer.shadowOffset = CGSizeMake(2, 5);
    plusBtn.layer.shadowOpacity = 0.8;
