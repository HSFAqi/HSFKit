...
@property (assign, nonatomic, getter=isShowBaseline) BOOL showBaseline;
/** 是否显示遮盖 默认为NO */
@property (assign, nonatomic, getter=isShowCover) BOOL showCover;
/** 是否显示滚动条 默认为NO*/
@property (assign, nonatomic, getter=isShowLine) BOOL showLine;
@property (assign, nonatomic, getter=isShowLineArrow) BOOL showLineArrow;
/** 是否显示图片 默认为NO*/
...
@property (strong, nonatomic) UIColor *scrollLineArrowColor;
/** 遮盖的颜色 */
